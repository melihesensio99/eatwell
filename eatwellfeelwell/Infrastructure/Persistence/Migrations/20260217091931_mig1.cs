        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImageFrontUrl = table.Column<string>(type: "text", nullable: true),
                    AdditivesN = table.Column<int>(type: "integer", nullable: true),
                    AdditivesTags = table.Column<string[]>(type: "text[]", nullable: true),
                    AllergensFromIngredients = table.Column<string>(type: "text", nullable: true),
                    AllergensHierarchy = table.Column<string[]>(type: "text[]", nullable: true),
                    NovaGroup = table.Column<string>(type: "text", nullable: true),
                    QualityTags = table.Column<string[]>(type: "text[]", nullable: true),
                    NutritionGrades = table.Column<string>(type: "text", nullable: true),
                    NutritionScoreBeverage = table.Column<int>(type: "integer", nullable: true),
                    Salt100g = table.Column<float>(type: "real", nullable: true),
                    Fat100g = table.Column<float>(type: "real", nullable: true),
                    SaturatedFat100g = table.Column<float>(type: "real", nullable: true),
